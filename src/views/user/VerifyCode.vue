<template>
    <div class="  h-screen">
        <div class="mt-24 mb-5 w-96 flex flex-col mx-auto  m-auto rounded-lg">
            <ps-label-title class="mt-8 mx-auto text-2xl" > {{ $t("verify_code__verify_your_phone") }} </ps-label-title>
