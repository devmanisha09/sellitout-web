<template>
    <div>
        <div class=" mt-28  flex flex-col">
            ...
            <div class="mt-8 content-center mx-auto w-96"  >
            ...
            <div class="w-55 lg:w-80 flex flex-col mx-auto rounded-lg">
                ...
                <ps-input class="lg:mt-2 mt-1" type="email" v-bind:placeholder="$t('login__email_placeholder')" v-on:keyup.enter="normalLoginClicked" v-model:value="email" @blur="validateEmail"></ps-input>
                ...
                <div class='flex flex-row items-start mt-3 lg:mt-4'>
                    <ps-checkbox-value title="" 
                        class="" v-model:value="agreePrivacyPolicy" 
