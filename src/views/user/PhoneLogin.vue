<template>
    <div class=" mt-18 bg-primary-500 dark:bg-primaryDark-accent  h-screen flex flex-col">
        
        <div class="mt-18 mb-5 w-96 flex flex-col mx-auto bg-gray-50 dark:bg-gray-800  m-auto rounded-lg">
            ...
            <ps-input class="mt-2 mx-8" type="text" v-bind:placeholder="$t('phone_login__user_name')" v-on:keyup.enter="clicked" v-model:value="name"></ps-input>
            <ps-label-caption class="mt-2 mx-8">( Please input first name and last name with a space as a separator in between them. eg: Admin Admin )</ps-label-caption>

            <ps-label class="mt-4 mx-8 "> {{ $t("phone_login__phone_number") }} : </ps-label>
            <ps-input class="mt-2 mx-8" type="text" v-bind:placeholder="$t('phone_login__phone_number_placeholder')" v-on:keyup.enter="clicked" v-model:value="phone"></ps-input>
