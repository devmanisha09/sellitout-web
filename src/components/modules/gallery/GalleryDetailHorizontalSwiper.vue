        ...
        <template #body>
            <div class="w-screem flex flex-row justify-between">
                <div class="my-auto" @click="leftArrowClicked">
                    <ps-icon name="leftArrow" class='stroke-current stroke-0 ' textColor="text-secondary-400 dark:text-secondaryDark-grey" w="100" h="100" />
                </div>
                ...
                <div class="my-auto cursor-pointer"  @click="rightArrowClicked">
                    <ps-icon  name="rightArrow" class='stroke-current stroke-0 ' textColor="text-secondary-400 dark:text-secondaryDark-grey" w="100" h="100"  />
                </div>
            </div>
        </template>
