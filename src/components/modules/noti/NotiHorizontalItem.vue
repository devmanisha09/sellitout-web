    ...
    <div class=" w-full cursor-pointer h-20 bg-primary-000 dark:bg-primaryDark-black p-2 rounded-2xl" v-on:click="onClick != null ? onClick(noti) : null">
        <div class="flex flex-row">
            ...
            <div class="sm:w-36 w-24 h-16 ">
                <img alt="Placeholder" width="15px" height="10px" class="block w-full h-full rounded-2xl object-contain" :src="notiProvider.imageUrl(noti ? noti.defaultPhoto.imgPath : '') " @error="notiProvider.defaultCarImage">
            </div>
            </div>
