            ...
            <div class="flex justify-between container w-full p-4">
                ...
                <div class="flex flex-col w-full  ">
                    <div class="flex flex-row w-full justify-center shadow-lg mb-4">
                        ...
                        <div class="my-4">
                            <img alt="Placeholder" width="300px" height="300px" class="rounded-sm w-20 h-20 flex items-center justify-center object-contail" :src="chatHistoryProvider.imageUrl(itemImage? itemImage : '')" @error="chatHistoryProvider.defaultCarImage" >
                        </div>
