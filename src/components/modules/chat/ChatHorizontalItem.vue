            ...
            <div class="flex flex-row items-center w-full justify-end " >
                <div class="flex-grow w-full justify-start flex flex-row">
                    <div class=" lg:px-3 py-3 sm:px-2 px-1">
                        <img alt="Placeholder" width="100px" height="100px" class="rounded-full bg-transparent lg:w-14 lg:h-14 w-11 h-11  flex object-cover" :src="chathistorylistProvider.imageUrl(chathistory ? chathistory.seller.userProfilePhoto : '')" @error="chathistorylistProvider.defaultProfileImage" >
                    </div>
                ...
                <div class="lg:w-60 w-36 h-18 sm:h-20 rounded-xl bg-primary-000 dark:bg-primaryDark-black">
                    <img alt="Placeholder"  width="400px" height="400px" class="w-36 h-18 sm:h-20 lg:w-60 rounded-xl object-contain" :src="chathistorylistProvider.imageUrl(chathistory ? chathistory.item.defaultPhoto.imgPath : '') " @error="chathistorylistProvider.defaultCarImage" >
                </div>
