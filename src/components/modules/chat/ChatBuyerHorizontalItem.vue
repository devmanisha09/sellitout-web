            ...
            <div class="flex flex-row items-center w-full justify-end " >
                <div class="flex-grow w-full justify-start flex flex-row">
                    <div class=" lg:px-3 py-3 sm:px-2 px-1">
                        <img alt="Placeholder" width="400" height="400" class="rounded-full bg-transparent lg:w-14 lg:h-14 w-11 h-11  flex object-cover" :src="chathistorylistProvider.imageUrl(chathistory ? chathistory.buyer.userProfilePhoto : '')" @error="chathistorylistProvider.defaultProfileImage" >
                    </div>
