<template>
    <div class="cursor-text sm:w-11/12 md:w-full" >
        ...
        <ps-card class="flex-col bg-primary-000 dark:bg-primaryDark-black lg:p-5 p-3">
            <div class="w-full">
                <img alt="Placeholder" width="500px" height="500px" class="rounded-full w-16 h-16 lg:w-24 lg:h-24 object-cover mx-auto" :src="blockuserProvider.imageUrl(block ? block.userProfilePhoto : '')" @error="blockuserProvider.defaultProfileImage"  >
