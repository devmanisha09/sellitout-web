<template>
    <div class="cursor-pointer sm:w-11/12 md:w-full" v-on:click="onClick != null ? onClick(user) : null">
        <!-- Pscard -->
         <ps-card class="flex-col bg-primary-000 dark:bg-primaryDark-black lg:p-5 p-3">
            <div class="w-full">
                <img alt="Placeholder" width="15px" height="10px" class="rounded-full w-16 h-16 lg:w-24 lg:h-24 object-cover mx-auto" :src="userProvider.imageUrl(user ? user.userProfilePhoto : '')" @error="userProvider.defaultProfileImage"  >
