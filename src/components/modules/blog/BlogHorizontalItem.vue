<template>
    <div class="rounded-xl lg:rounded-2xl cursor-pointer lg:p-2 lg:pb-4 p-1 pb-2 bg-primary-000 dark:bg-primaryDark-black w-full h-full" v-on:click="onClick != null ? onClick(blog) : null">
        <img alt="Placeholder" class="rounded-lg block w-full lg:h-32 h-20 object-cover" width="360px" height="100px" v-lazy="blogProvider.imageUrl(blog ? blog.defaultPhoto.imgPath : '') " @error="blogProvider.defaultCarImage">
